  ...
  "rules": [
    {
      ...
      "expression": "(http.request.uri.path starts_with \"/api/\") or (http.request.uri.path starts_with \"/entrar\") or (http.request.uri.path starts_with \"/login\") or (http.request.uri.path starts_with \"/dashboard\") or (http.request.uri.path starts_with \"/webhook/\") or (http.request.uri.path starts_with \"/pwa-\") or (http.request.uri.path starts_with \"/axecloud_\") or (http.request.uri.path eq \"/favicon.ico\") or (http.request.uri.path eq \"/manifest.webmanifest\") or (http.request.uri.path eq \"/sw.js\")",
