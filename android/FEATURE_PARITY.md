...
| Notificações | pendências reais, push, deep links, preferências e histórico | PARCIAL — inbox derivada das pendências reais, leitura sincronizada entre aparelhos, preferências nativas por categoria, sincronização periódica Android em segundo plano e deep links para o módulo correto compilados; push instantâneo com entrega do servidor pendente |
