...
export default function Home() {
  ...
  const websiteJsonLd = { "@context": "https://schema.org", "@type": "WebSite", "@id": "https://axecloud.com.br/#website", url: "https://axecloud.com.br/", name: "AxéCloud", alternateName: "AxéCloud Gestão para Terreiros", publisher: { "@id": "https://axecloud.com.br/#organization" }, inLanguage: "pt-BR" };
    ...
    <section className="cx-opening cx-conversion-hero" aria-labelledby="hero-title">
      ...
      <div className="cx-conversion-shell">
        <div className="cx-conversion-copy">
          ...
          <h1 id="hero-title">Sistema de gestão para terreiros.<span>Toda a casa em um só lugar.</span></h1>
          <p className="cx-hero-lead">O AxéCloud organiza filhos de santo, mensalidades, giras, comunicados, documentos e financeiro para terreiros de Umbanda e Candomblé.</p>
