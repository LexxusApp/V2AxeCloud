...
export default function Home() {
  ...
  return <main className="cinema-house" ref={root} id="inicio">
    ...
    <header className="cx-header"><Brand /><nav aria-label="Navegação principal"><a href="#casa">A casa</a><a href="#organizacao">O que resolve</a><a href="#seguranca">Segurança</a><a href="#memoria">Memória</a><a href="#descobrir">Explorar</a><a href="https://axecloud.com.br/terreiros">Terreiros</a><a href="https://axecloud.com.br/eventos">Eventos</a><a href="https://axecloud.com.br/conteudo">Conteúdo</a><a href="https://axecloud.com.br/por-que-axecloud">Por quê?</a><a href="#faq">FAQ</a><a href="#plano">Planos</a></nav><a className="cx-header-contact" href={CONTACT_URL} target="_blank" rel="noreferrer">Fale conosco</a><a className="cx-header-login" href="/entrar">Entrar</a><a className="cx-header-cta" href="https://axecloud.com.br/register">Testar 30 dias <ArrowRight /></a><button type="button" aria-label={menu ? "Fechar menu" : "Abrir menu"} aria-expanded={menu} aria-controls="menu-principal" onClick={() => setMenu(!menu)}>{menu ? <X /> : <Menu />}</button>{menu && <div className="cx-menu" id="menu-principal" role="navigation" aria-label="Navegação móvel" onClick={() => setMenu(false)}><a href="#casa">A casa</a><a href="#organizacao">O que resolve</a><a href="#seguranca">Segurança</a><a href="#memoria">Memória</a><a href="#descobrir">Explorar</a><a href="https://axecloud.com.br/terreiros">Terreiros</a><a href="https://axecloud.com.br/eventos">Eventos</a><a href="https://axecloud.com.br/conteudo">Conteúdo</a><a href="https://axecloud.com.br/por-que-axecloud">Por quê?</a><a href="#faq">FAQ</a><a href="#plano">Planos</a><div className="cx-menu-actions"><a className="cx-menu-login" href="/entrar">Entrar</a><a className="cx-menu-contact" href={CONTACT_URL} target="_blank" rel="noreferrer">Fale conosco</a><a className="cx-menu-trial" href="https://axecloud.com.br/register">Testar 30 dias <ArrowRight /></a></div></div>}</header>
