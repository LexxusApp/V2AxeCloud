    ...
    <div className="space-y-4">
      <div className="grid gap-3 sm:grid-cols-2">
        <div className={cn(admin.card, "p-5")}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="admin-label">Cliques acumulados</p>
      ...
      <section className={admin.card}>
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[var(--ac-paper-border)] p-4">
          <div>
            <h2 className="font-semibold text-[var(--ac-text)]">Terreiros mais visitados</h2>
            <p className="mt-0.5 text-xs text-[var(--ac-text-muted)]">Total histórico; a contagem não reinicia por dia ou mês.</p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className={admin.table}>
              <thead><tr className={admin.thead}>
                ...
                <th className={cn(admin.th, "w-36 text-right")}>Visitas</th>
              </tr></thead>
              <tbody>
