...
export function resolveDiretorioTipo(stored, nome, categoriaMaps) {
  // Heurística de loja/comercial vence tipo gravado errado no banco.
  const classified = classifyDiretorioEstabelecimento(nome, categoriaMaps);
  if (classified === "loja") return "loja";
