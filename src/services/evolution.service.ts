/**
 * Chamadas centralizadas à Evolution API (WhatsApp Business Cloud API).
 * Instância oficial única: axecloud_console_admin
 */
...
/** Nome canónico da instância oficial AxéCloud (Meta Cloud API). */
