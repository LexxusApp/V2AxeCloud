...
export function FilhoPushPrompt({ permission, loading, onSubscribe }: FilhoPushPromptProps) {
  ...
  if (permission === 'denied') {
    return (
      <div className="filho-push-prompt is-denied mx-auto flex w-full max-w-2xl items-start gap-3 px-4 py-3">
  ...
  return (
    <div className="filho-push-prompt mx-auto flex w-full max-w-2xl flex-col items-center gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-center">
